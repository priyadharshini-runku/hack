                ...
                <div className="flex items-center justify-between pt-2 border-t border-amber-200/60 flex-wrap gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="text-xs font-semibold text-slate-600 hover:text-slate-800 bg-white hover:bg-slate-50 px-2.5 py-1 rounded-lg border border-slate-200 transition-colors flex items-center gap-1"
