...
export const Navbar = ({ activePage, setActivePage }) => {
  ...
  return (
  <header className="sticky top-0 z-30 bg-[#050806]/90 backdrop-blur-xl border-b border-emerald-500/10 shadow-[0_4px_30px_rgba(0,0,0,0.25)] transition-all">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          >
           className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-400 via-green-500 to-emerald-800 flex items-center justify-center text-white shadow-lg shadow-emerald-500/20 group-hover:scale-105 group-hover:shadow-emerald-500/40 transition-all"
  ...
  Skill<span className="text-emerald-400">Bridge</span>
             ...
             <p className="text-[10px] text-slate-400 font-medium tracking-wide">Academia · Industry · Placement</p>
            </div>
          </div>
...
/>
          ...
          <div className="hidden sm:flex items-center gap-2.5">
            <button
             ...
             className="text-xs font-semibold px-3 py-1.5 text-slate-300 hover:text-emerald-400 hover:bg-white/5 rounded-lg transition-all"
              Sign In
            </button>
            <button
              onClick={() => setActivePage('register')}
              className="text-xs font-semibold px-4 py-2 bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-400 hover:to-green-500 text-white rounded-lg shadow-lg shadow-emerald-500/20 hover:shadow-emerald-500/40 transition-all"
            >
              Register
            </button>
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 p-1.5 rounded-full hover:bg-white/5 border border-white/10 hover:border-emerald-500/30 transition-all"
              >
                <img 
                  src={user.avatar} 
                  alt={user.name} 
                  className="w-7 h-7 rounded-full object-cover ring-1 ring-emerland-500/300"
                />
